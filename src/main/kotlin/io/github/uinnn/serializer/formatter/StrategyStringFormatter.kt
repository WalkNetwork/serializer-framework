...
open class StrategyStringFormatter(
  override val model: io.github.uinnn.serializer.AlterableStringFormat,
  encoder: EncoderStrategy,
  decoder: DecoderStrategy,
) : StrategyFormatter(model, encoder, decoder), io.github.uinnn.serializer.AlterableStringFormat by model {
